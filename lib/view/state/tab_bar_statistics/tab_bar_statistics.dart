...
import 'package:quran/view/state/controllers/tab_bar_controller_page_statistics.dart';
import 'package:quran/view/state/tab_bar_statistics/all_page.dart';
import 'package:quran/view/state/tab_bar_statistics/daily_page.dart';
import 'package:quran/view/state/tab_bar_statistics/weekly_page.dart';

class TabBarStatistics extends StatelessWidget {
  TabBarStatistics({super.key});
  final PageController _pageController = PageController();
  final TabBarControllerPageStatistics _tabController =
      Get.put(TabBarControllerPageStatistics());
  @override
